...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public static final String URL_SAVE_NAME = "http://192.168.0.7/android/saveName.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*listViewNames.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1,
                ...
                Object item = listViewNames.getItemAtPosition(position);
                Toast.makeText(getApplicationContext(),
                        "Button is clicked "+ item, Toast.LENGTH_LONG).show();
